...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function buildBalanceSegment(dict, data) {
			...
			// The two readings are two labelled pairs, so they are separated by
			// the bar the bar itself uses between segments (not a middot: each
			// half already carries its own 费用/余额 label).
