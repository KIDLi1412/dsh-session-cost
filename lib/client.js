...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		/**
		 * The session-cost pill glyph: a banknote. Deliberately NOT a ¥ badge —
		 ...
		 * A banknote reads as "cost/charges" without repeating the unit, and
		 * stays legible at the pill's 14 px like the built-in gauge/database
		 * glyphs.
		 */
		function costIconSvg() {
			return svgEl({
				...
				children: [
					["rect", {
						x: "1.5", y: "3.75", width: "13", height: "8.5", rx: "2",
						fill: "none", stroke: "currentColor", "stroke-width": "1.2"
					}],
					["circle", { cx: "8", cy: "8", r: "2", fill: "currentColor" }],
					["circle", { cx: "4.5", cy: "8", r: "0.7", fill: "currentColor" }],
		...
		/** The panel's title glyph: the same banknote at title scale. */
